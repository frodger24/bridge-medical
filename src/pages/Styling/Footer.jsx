    ...
    <footer className="footer" id="footer">
      <div className="footer-content">
        ...
        <div className="social-sec">
          ...
          <div className="social-icons">
            <a
              href="https://www.linkedin.com/posts/bridge-medical-ny_activity-7311108174223163392-z7DY"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Bridge Medical LinkedIn"
            >
              <FaLinkedin size={24} />
            </a>
            <a
              href="https://www.instagram.com/bridgemedicalny/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Bridge Medical Instagram"
            >
              <FaInstagram size={24} />
            </a>
          </div>
      ...
      <div className="map-section">
        ...
        <div className="map-block">
          <h4>Staten Island</h4>
          <iframe
            src="https://maps.google.com/maps?q=4131%20Richmond%20Avenue%20Staten%20Island%20NY%2010312&z=14&output=embed"
            width="100%"
            height="300"
            style={{ border: 0 }}
            allowFullScreen
